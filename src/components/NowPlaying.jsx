...
const NowPlaying = () => {
  ...
  console.log('🎧 NowPlaying - currentTrack:', currentTrack ? currentTrack.title : 'هیچ');
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-1 mt-2">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className={`visualizer-bar ${isPlaying ? 'opacity-100' : 'opacity-20'}`}
                style={{ height: `${10 + Math.random() * 25}px` }}
              ></div>
            ))}
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`p-2 rounded-full transition ${
              shuffle ? 'text-purple-400 bg-purple-500/20' : 'text-white/40 hover:text-white'
            }`}
          >
            <Shuffle size={22} />
          </button>
          ...
          <button
            ...
            className={`p-2 rounded-full transition ${
              repeat ? 'text-purple-400 bg-purple-500/20' : 'text-white/40 hover:text-white'
            }`}
          >
            <Repeat size={22} />
          </button>
